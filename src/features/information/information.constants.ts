...
export const INFO_COMMAND_GROUPS: readonly CommandGroup[] = [
  {
    ...
    commands: [
      {
        name: "gift",
        description: "Regala puntos a otro usuario.",
      },
      {
        name: "beg",
        description: "Mendiga puntos y prueba suerte.",
      },
      {
        name: "balance",
        description: "Consulta cuántos puntos tienes.",
      },
    ],
  },
  {
    ...
    commands: [
      ...
      {
        name: "minefield",
        description: `Planta minas en el canal principal (${MINE_COST}pts cada una).`,
      },
      {
        name: "uwufier",
  ...
  },
  {
    ...
    commands: [
      {
        name: "roll",
        description: "Tira los dados que elijas.",
      },
      {
        name: "reminder",
        description: "Te aviso con una mención cuando pase el tiempo que elijas.",
      },
      {
        name: "birthday",
  ...
  },
  {
    ...
    commands: [
      {
        name: "scan",
        description: "Enséñame una imagen y te diré qué veo.",
      },
      {
        name: "monster-time",
        description: "Enséñame tu Monster, más te vale que sea viernes.",
      },
    ],
  },
  {
    ...
    commands: [
      {
        name: "cheer",
        description: "Felicita el cumpleaños a alguien.",
      },
      {
        name: "slap",
        description: `Dale un slap a quien se lo merezca (${SLAP_COST}pts).`,
      },
      {
        name: "speak",
        description: `Me uno a tu canal de voz y suelto una frase (${SPEAK_COST}pts).`,
      },
    ],
  },
  {
    ...
    commands: [
      {
        name: "info",
        description: "Muestra esta misma lista de comandos.",
      },
      {
        name: "profile",
  ...
  },
  {
    ...
    commands: [
      {
        name: "exclude",
        description: "Excluye a un usuario de mis actividades, o lo readmite.",
      },
      {
        name: "punish",
  ...
  },
  {
    ...
    commands: [
      ...
      {
        name: "deploy",
        description: "Gestiona el registro de comandos (solo dueño).",
      },
      {
        name: "add-channel",
        description: "Añade un canal extra para algunas de mis funciones.",
      },
    ],
  },
];
